...
?>
<section class="webbakit-widget webbakit-hero webbakit-hero--style-3">
	<div class="webbakit-hero__card">
		...
		<?php if ( $image_url ) : ?><div class="webbakit-hero__floating"><?php if ( ! empty( $settings['badge_text'] ) ) : ?><span class="webbakit-hero__floating-badge"><?php echo esc_html( $settings['badge_text'] ); ?></span><?php endif; ?><img class="webbakit-hero__image" src="<?php echo $image_url; ?>" alt=""></div><?php endif; ?>
	</div>
</section>
