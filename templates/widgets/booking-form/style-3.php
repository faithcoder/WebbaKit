...
?>
<section class="webbakit-widget webbakit-booking-form webbakit-booking-form--style-3">
	<div class="webbakit-booking-form__panel webbakit-booking-form__panel--highlight">
		<div class="webbakit-booking-form__copy">
