...
?>
<section class="webbakit-widget webbakit-services webbakit-services--style-3">
	...
	<div class="webbakit-services__grid" style="<?php echo esc_attr( $style ); ?>">
		<?php foreach ( $services as $service ) : ?>
			<article class="webbakit-services__card webbakit-services__card--pricing">
				<div class="webbakit-services__meta-row"><span class="webbakit-services__meta"><?php echo esc_html( $service['duration'] ?? '' ); ?></span><?php if ( ! empty( $service['price'] ) ) : ?><strong class="webbakit-services__price"><?php echo esc_html( $service['price'] ); ?></strong><?php endif; ?></div>
